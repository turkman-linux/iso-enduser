...
ymp it @cinnamon caribou dejavu adwaita-icon-theme gsettings-desktop-schemas polkit-gnome elementary-appcenter --no-emerge --allow-oem
chmod u+s /usr/libexec/polkit-gnome-authentication-agent-1
