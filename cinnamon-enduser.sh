...
ymp it @cinnamon caribou dejavu adwaita-icon-theme gsettings-desktop-schemas polkit-gnome elementary-appcenter pavucontrol gnome-terminal --no-emerge --allow-oem
